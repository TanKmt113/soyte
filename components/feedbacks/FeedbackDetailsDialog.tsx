  ...
  return (
    ...
    >
      <div className="flex flex-col h-full text-sm">
          ...
          <div className="flex flex-wrap items-start justify-between gap-4 mb-3">
            ...
            <div className="flex flex-wrap items-center gap-2 flex-shrink-0">
              <span className="text-xs text-slate-500 bg-slate-100 px-3 py-1.5 rounded-lg border border-slate-200">
                ...
                {selectedFeedback.created_at ? formatDisplayDateTime(selectedFeedback.created_at) : "—"}
              </span>
        ...
        {/* PHỤ LỤC TABLE */}
        {selectedFeedback.type === 'phuluc' && selectedFeedback.sections && selectedFeedback.sections.length > 0 && (
        ...
        {/* BIỂU MẪU SECTIONS */}
        {selectedFeedback.type === 'bieumau' && selectedFeedback.sections && selectedFeedback.sections.length > 0 && (
